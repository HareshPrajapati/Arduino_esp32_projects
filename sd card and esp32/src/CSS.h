String webpage = "";
#define ServerVersion "Mikrotroniks SD card"
...
void append_page_header() {
  ...
  webpage += F("</style></head><body><h1>"); webpage += String(ServerVersion) + "</h1>";
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void append_page_footer(){ // Saves repeating many lines of code for HTML page footers
  ...
  webpage += F("</ul>");
  webpage += "<footer>&copy;"+String(char(byte(0x40>>1)))+String("Mikrotroniks.");
  webpage += String(2020)+"</footer>";
  webpage += F("</body></html>");
}
